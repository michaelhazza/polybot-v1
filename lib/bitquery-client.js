...
class BitqueryClient {
  ...
  async queryPolymarketTradesByTokens(startTime, endTime, tokenIds = [], limit = 1000, offset = 0) {
    ...
    // Build query with server-side token ID filtering
    const query = `
      query ($startTime: DateTime, $endTime: DateTime, $tokenIds: [String!], $limit: Int!, $offset: Int!) {
    ...
    const variables = { startTime, endTime, tokenIds, limit, offset };
